#!/bin/bash
declare algorithms=("chi_n_imit" "comb_imit" "static_imit" "damping_imit" "decay_rate_cc_imit" "decay_rate_cs_imit" "evolution_path_pc_imit" "evolution_path_ps_imit" "h_sigma_imit" "learning_rate_c1_imit" "learning_rate_cm_imit" "mu_effective_imit" "step_size_imit")
