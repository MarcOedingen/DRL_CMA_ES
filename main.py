...
def main():
    ...
    parser.add_argument('--algorithm', type=str, help='The dataset to use', choices=['baseline', 'stepsize'],default='stepsize')
    parser.add_argument('--dimension', type=int, help='The dimension of the problem', default=2)
    parser.add_argument('--xstart', type=str, help='The dataset to use', choices=['zero', 'random'],default='zero')
