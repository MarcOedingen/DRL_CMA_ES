...
def run(
    ...
    train_env = TimeLimit(
        CMA_ES_CC(objective_funcs=train_funcs, x_start=x_start, sigma=sigma, reward_type=reward_type),
    ...
    policy_path = "Environments/Decay_Rate/Policies/ppo_policy_cc_imit"
