...
def run(
    ...
    if os.path.exists(
        f"Environments/h_Sigma/Policies/ppo_policy_hs_imit_{dimension}D_{instance}I.pkl"
    ):
    ...
    g_utils.save_results(results=results, policy=f"ppo_policy_hs_imit_{dimension}D_{instance}I")
