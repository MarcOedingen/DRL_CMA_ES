...
def run(
    ...
    train_env = TimeLimit(
        CMA_ES_PS(objective_funcs=train_funcs, x_start=x_start, sigma=sigma),
    ...
    if os.path.exists(
        f"Environments/Evolution_Path/Policies/ppo_policy_ps_imit_{dimension}D_{instance}I.pkl"
    ):
