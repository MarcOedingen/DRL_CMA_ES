...
from Environments.Learning_Rate.CMA_ES_C1 import collect_expert_samples
...
def run(
    ...
    if os.path.exists(
        f"Environments/Learning_Rate/Policies/ppo_policy_c1_imit_{dimension}D_{instance}I.pkl"
    ):
    ...
    g_utils.save_results(results=results, policy=f"ppo_policy_c1_imit_{dimension}D_{instance}I")
