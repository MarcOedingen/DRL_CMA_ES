...
def run(
    ...
    if os.path.exists(
        f"Environments/Learning_Rate/Policies/ppo_policy_cm_imit_{dimension}D_{instance}I.pkl"
    ):
    ...
    g_utils.save_results(results=results, policy=f"ppo_policy_cm_imit_{dimension}D_{instance}I")
